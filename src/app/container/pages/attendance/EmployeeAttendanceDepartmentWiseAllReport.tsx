...
export default function EmployeeAttendanceDepartmentWiseAllReport() {
  ...
  const attendanceDetailsDepartmentEmployee = useStoreState(
    (state) => state.attendance.attendanceDetailsDepartmentEmployee
  );
  const fetchattendanceDetailsDepartmentEmployee = useStoreActions(
    (state) => state.attendance.fetchattendanceDetailsDepartmentEmployee
  );
  ...
  const columns = [
    ...
    ...(attendanceDetailsDepartmentEmployee?.firstDay !== ""
      ? [
        {
          title: attendanceDetailsDepartmentEmployee?.firstDay,
          dataIndex: "firstDay",
          key: "firstDay",
          showOnResponse: true,
          showOnDesktop: true,
    ...
    ...(attendanceDetailsDepartmentEmployee?.secondDay !== ""
      ? [
        {
          title: attendanceDetailsDepartmentEmployee?.secondDay,
          dataIndex: "secondDay",
          key: "secondDay",
          showOnResponse: true,
          showOnDesktop: true,
    ...
    ...(attendanceDetailsDepartmentEmployee?.thirdDay !== ""
      ? [
        {
          title: attendanceDetailsDepartmentEmployee?.thirdDay,
          dataIndex: "thirdDay",
          key: "thirdDay",
          showOnResponse: true,
          showOnDesktop: true,
    ...
    ...(attendanceDetailsDepartmentEmployee?.fourthDay !== ""
      ? [
        {
          title: attendanceDetailsDepartmentEmployee?.fourthDay,
          dataIndex: "fourthDay",
          key: "fourthDay",
          showOnResponse: true,
          showOnDesktop: true,
    ...
    ...(attendanceDetailsDepartmentEmployee?.fifthDay !== ""
      ? [
        {
          title: attendanceDetailsDepartmentEmployee?.fifthDay,
          dataIndex: "fifthDay",
          key: "fifthDay",
          showOnResponse: true,
          showOnDesktop: true,
    ...
    ...(attendanceDetailsDepartmentEmployee?.sixthDay !== ""
      ? [
        {
          title: attendanceDetailsDepartmentEmployee?.sixthDay,
          dataIndex: "sixthDay",
          key: "sixthDay",
          showOnResponse: true,
          showOnDesktop: true,
    ...
    ...(attendanceDetailsDepartmentEmployee?.seventhDay !== ""
      ? [
        {
          title: attendanceDetailsDepartmentEmployee?.seventhDay,
    ...
    ...(attendanceDetailsDepartmentEmployee?.eighthDay !== ""
      ? [
        {
          title: attendanceDetailsDepartmentEmployee?.eighthDay,
          dataIndex: "eighthDay",
          key: "eighthDay",
          showOnResponse: true,
          showOnDesktop: true,
    ...
    ...(attendanceDetailsDepartmentEmployee?.ninethDay !== ""
      ? [
        {
          title: attendanceDetailsDepartmentEmployee?.ninethDay,
          dataIndex: "ninethDay",
          key: "ninethDay",
          showOnResponse: true,
          showOnDesktop: true,
    ...
    ...(attendanceDetailsDepartmentEmployee?.tenthDay !== ""
      ? [
        {
          title: attendanceDetailsDepartmentEmployee?.tenthDay,
          dataIndex: "tenthDay",
          key: "tenthDay",
          showOnResponse: true,
          showOnDesktop: true,
    ...
    ...(attendanceDetailsDepartmentEmployee?.eleventhDay !== ""
      ? [
        {
          title: attendanceDetailsDepartmentEmployee?.eleventhDay,
    ...
    ...(attendanceDetailsDepartmentEmployee?.twelvethDay !== ""
      ? [
        {
          title: attendanceDetailsDepartmentEmployee?.twelvethDay,
    ...
    ...(attendanceDetailsDepartmentEmployee?.thirteenthDay !== ""
      ? [
        {
          title: attendanceDetailsDepartmentEmployee?.thirteenthDay,
      ...
      : []),
    ...(attendanceDetailsDepartmentEmployee?.fourteenthDay !== ""
      ? [
        {
          title: attendanceDetailsDepartmentEmployee?.fourteenthDay,
    ...
    ...(attendanceDetailsDepartmentEmployee?.fifteenthDay !== ""
      ? [
        {
          title: attendanceDetailsDepartmentEmployee?.fifteenthDay,
    ...
    ...(attendanceDetailsDepartmentEmployee?.sixteenthDay !== ""
      ? [
        {
          title: attendanceDetailsDepartmentEmployee?.sixteenthDay,
    ...
    ...(attendanceDetailsDepartmentEmployee?.seventeenthDay !== ""
      ? [
        {
          title: attendanceDetailsDepartmentEmployee?.seventeenthDay,
    ...
    ...(attendanceDetailsDepartmentEmployee?.eighteenthDay !== ""
      ? [
        {
          title: attendanceDetailsDepartmentEmployee?.eighteenthDay,
    ...
    ...(attendanceDetailsDepartmentEmployee?.nineteenthDay !== ""
      ? [
        {
          title: attendanceDetailsDepartmentEmployee?.nineteenthDay,
    ...
    ...(attendanceDetailsDepartmentEmployee?.twentythDay !== ""
      ? [
        {
          title: attendanceDetailsDepartmentEmployee?.twentythDay,
    ...
    ...(attendanceDetailsDepartmentEmployee?.twentyFirstDay !== ""
      ? [
        {
          title: attendanceDetailsDepartmentEmployee?.twentyFirstDay,
    ...
    ...(attendanceDetailsDepartmentEmployee?.twentySecondDay !== ""
      ? [
        {
          title: attendanceDetailsDepartmentEmployee?.twentySecondDay,
    ...
    ...(attendanceDetailsDepartmentEmployee?.twentyThirdDay !== ""
      ? [
        {
          title: attendanceDetailsDepartmentEmployee?.twentyThirdDay,
    ...
    ...(attendanceDetailsDepartmentEmployee?.twentyFourthDay !== ""
      ? [
        {
          title: attendanceDetailsDepartmentEmployee?.twentyFourthDay,
    ...
    ...(attendanceDetailsDepartmentEmployee?.twentyFifthDay !== ""
      ? [
        {
          title: attendanceDetailsDepartmentEmployee?.twentyFifthDay,
    ...
    ...(attendanceDetailsDepartmentEmployee?.twentySixthDay !== ""
      ? [
        {
          title: attendanceDetailsDepartmentEmployee?.twentySixthDay,
    ...
    ...(attendanceDetailsDepartmentEmployee?.twentySeventhDay !== ""
      ? [
        {
          title: attendanceDetailsDepartmentEmployee?.twentySeventhDay,
    ...
    ...(attendanceDetailsDepartmentEmployee?.twentyEighthDay !== ""
      ? [
        {
          title: attendanceDetailsDepartmentEmployee?.twentyEighthDay,
    ...
    ...(attendanceDetailsDepartmentEmployee?.twentyNinethDay !== ""
      ? [
        {
          title: attendanceDetailsDepartmentEmployee?.twentyNinethDay,
                ...
                <Button
                  ...
                  onClick={() => {
                    ...
                    excel
                      ...
                      .addColumns(columns)
                      .addDataSource(
                        attendanceDetailsDepartmentEmployee?.staffList,
                        { str2Percent: true }
                      )
