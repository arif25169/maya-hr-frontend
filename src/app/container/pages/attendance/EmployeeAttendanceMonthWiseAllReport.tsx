...
export default function EmployeeAttendanceMonthWiseAllReport() {
    ...
    const columns = [
        ...
        ...(attendanceDetailsAllEmployee2?.firstDay!=='')? [{ title: attendanceDetailsAllEmployee2?.firstDay, dataIndex: 'firstDay', key: 'firstDay', showOnResponse: true, showOnDesktop: true }]:[],
        ...(attendanceDetailsAllEmployee2?.secondDay!=='')? [{ title: attendanceDetailsAllEmployee2?.secondDay, dataIndex: 'secondDay', key: 'secondDay', showOnResponse: true, showOnDesktop: true }]:[],
        ...(attendanceDetailsAllEmployee2?.thirdDay!=='')? [{ title: attendanceDetailsAllEmployee2?.thirdDay, dataIndex: 'thirdDay', key: 'thirdDay', showOnResponse: true, showOnDesktop: true }]:[],
        ...(attendanceDetailsAllEmployee2?.fourthDay!=='')? [{ title: attendanceDetailsAllEmployee2?.fourthDay, dataIndex: 'fourthDay', key: 'fourthDay', showOnResponse: true, showOnDesktop: true }]:[],
        ...(attendanceDetailsAllEmployee2?.fifthDay!=='')? [{ title: attendanceDetailsAllEmployee2?.fifthDay, dataIndex: 'fifthDay', key: 'fifthDay', showOnResponse: true, showOnDesktop: true }]:[],
        ...(attendanceDetailsAllEmployee2?.sixthDay!=='')? [{ title: attendanceDetailsAllEmployee2?.sixthDay, dataIndex: 'sixthDay', key: 'sixthDay', showOnResponse: true, showOnDesktop: true }]:[],
        ...(attendanceDetailsAllEmployee2?.seventhDay!=='')? [{ title: attendanceDetailsAllEmployee2?.seventhDay, dataIndex: 'seventhDay', key: 'seventhDay', showOnResponse: true, showOnDesktop: true }]:[],
        ...(attendanceDetailsAllEmployee2?.eighthDay!=='')? [{ title: attendanceDetailsAllEmployee2?.eighthDay, dataIndex: 'eighthDay', key: 'eighthDay', showOnResponse: true, showOnDesktop: true }]:[],
        ...(attendanceDetailsAllEmployee2?.ninethDay!=='')? [{ title: attendanceDetailsAllEmployee2?.ninethDay, dataIndex: 'ninethDay', key: 'ninethDay', showOnResponse: true, showOnDesktop: true }]:[],
        ...(attendanceDetailsAllEmployee2?.tenthDay!=='')? [{ title: attendanceDetailsAllEmployee2?.tenthDay, dataIndex: 'tenthDay', key: 'tenthDay', showOnResponse: true, showOnDesktop: true }]:[],
        ...(attendanceDetailsAllEmployee2?.eleventhDay!=='')? [{ title: attendanceDetailsAllEmployee2?.eleventhDay, dataIndex: 'eleventhDay', key: 'eleventhDay', showOnResponse: true, showOnDesktop: true }]:[],
        ...(attendanceDetailsAllEmployee2?.twelvethDay!=='')? [{ title: attendanceDetailsAllEmployee2?.twelvethDay, dataIndex: 'twelvethDay', key: 'twelvethDay', showOnResponse: true, showOnDesktop: true }]:[],
        ...(attendanceDetailsAllEmployee2?.thirteenthDay!=='')? [{ title: attendanceDetailsAllEmployee2?.thirteenthDay, dataIndex: 'thirteenthDay', key: 'thirteenthDay', showOnResponse: true, showOnDesktop: true }]:[],
        ...(attendanceDetailsAllEmployee2?.fourteenthDay!=='')? [{ title: attendanceDetailsAllEmployee2?.fourteenthDay, dataIndex: 'fourteenthDay', key: 'fourteenthDay', showOnResponse: true, showOnDesktop: true }]:[],
        ...(attendanceDetailsAllEmployee2?.fifteenthDay!=='')? [{ title: attendanceDetailsAllEmployee2?.fifteenthDay, dataIndex: 'fifteenthDay', key: 'fifteenthDay', showOnResponse: true, showOnDesktop: true }]:[],
        ...(attendanceDetailsAllEmployee2?.sixteenthDay!=='')? [{ title: attendanceDetailsAllEmployee2?.sixteenthDay, dataIndex: 'sixteenthDay', key: 'sixteenthDay', showOnResponse: true, showOnDesktop: true }]:[],
        ...(attendanceDetailsAllEmployee2?.seventeenthDay!=='')? [{ title: attendanceDetailsAllEmployee2?.seventeenthDay, dataIndex: 'seventeenthDay', key: 'seventeenthDay', showOnResponse: true, showOnDesktop: true }]:[],
        ...(attendanceDetailsAllEmployee2?.eighteenthDay!=='')? [{ title: attendanceDetailsAllEmployee2?.eighteenthDay, dataIndex: 'eighteenthDay', key: 'eighteenthDay', showOnResponse: true, showOnDesktop: true }]:[],
        ...(attendanceDetailsAllEmployee2?.nineteenthDay!=='')? [{ title: attendanceDetailsAllEmployee2?.nineteenthDay, dataIndex: 'nineteenthDay', key: 'nineteenthDay', showOnResponse: true, showOnDesktop: true }]:[],
        ...(attendanceDetailsAllEmployee2?.twentythDay!=='')? [{ title: attendanceDetailsAllEmployee2?.twentythDay, dataIndex: 'twentythDay', key: 'twentythDay', showOnResponse: true, showOnDesktop: true }]:[],
        ...(attendanceDetailsAllEmployee2?.twentyFirstDay!=='')? [{ title: attendanceDetailsAllEmployee2?.twentyFirstDay, dataIndex: 'twentyFirstDay', key: 'twentyFirstDay', showOnResponse: true, showOnDesktop: true }]:[],
        ...(attendanceDetailsAllEmployee2?.twentySecondDay!=='')? [{ title: attendanceDetailsAllEmployee2?.twentySecondDay, dataIndex: 'twentySecondDay', key: 'twentySecondDay', showOnResponse: true, showOnDesktop: true }]:[],
        ...(attendanceDetailsAllEmployee2?.twentyThirdDay!=='')? [{ title: attendanceDetailsAllEmployee2?.twentyThirdDay, dataIndex: 'twentyThirdDay', key: 'twentyThirdDay', showOnResponse: true, showOnDesktop: true }]:[],
        ...(attendanceDetailsAllEmployee2?.twentyFourthDay!=='')? [{ title: attendanceDetailsAllEmployee2?.twentyFourthDay, dataIndex: 'twentyFourthDay', key: 'twentyFourthDay', showOnResponse: true, showOnDesktop: true }]:[],
        ...(attendanceDetailsAllEmployee2?.twentyFifthDay!=='')? [{ title: attendanceDetailsAllEmployee2?.twentyFifthDay, dataIndex: 'twentyFifthDay', key: 'twentyFifthDay', showOnResponse: true, showOnDesktop: true }]:[],
        ...(attendanceDetailsAllEmployee2?.twentySixthDay!=='')? [{ title: attendanceDetailsAllEmployee2?.twentySixthDay, dataIndex: 'twentySixthDay', key: 'twentySixthDay', showOnResponse: true, showOnDesktop: true }]:[],
        ...(attendanceDetailsAllEmployee2?.twentySeventhDay!=='')? [{ title: attendanceDetailsAllEmployee2?.twentySeventhDay, dataIndex: 'twentySeventhDay', key: 'twentySeventhDay', showOnResponse: true, showOnDesktop: true }]:[],
        ...(attendanceDetailsAllEmployee2?.twentyEighthDay!=='')? [{ title: attendanceDetailsAllEmployee2?.twentyEighthDay, dataIndex: 'twentyEighthDay', key: 'twentyEighthDay', showOnResponse: true, showOnDesktop: true }]:[],
                                ...
                                < Button
                                    ...
                                    onClick={() => {
                                        ...
                                        excel
                                            .addSheet(`Attendance`)
                                            .addColumns(columns)
                                            .addDataSource(attendanceDetailsAllEmployee2?.staffList,{ str2Percent: true,})
