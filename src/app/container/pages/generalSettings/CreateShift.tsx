...
export default function CreateShift() {
    ...
    const updateSubmitForm = (value) => {
        ...
        let postData: any = {
            ...
            shiftDelayTime: value.shiftDelayTime
        }
    ...
    const columns = [
        ...
        { title: 'Start Time', dataIndex: 'shiftStartTime', key: 'shiftStartTime', showOnResponse: true, showOnDesktop: true },
        { title: 'Delay Time', dataIndex: 'shiftDelayTime', key: 'shiftDelayTime', showOnResponse: true, showOnDesktop: true },
        { title: 'End Time', dataIndex: 'shiftEndTime', key: 'shiftEndTime', showOnResponse: true, showOnDesktop: true },
        {
                        ...
                        <Button type='primary'
                            onClick={() => {
                                ...
                                updateForm.setFieldsValue({
                                    ...
                                    shiftDelayTime: record.shiftDelayTime,
                                });
    ...
    return (
        <>
            <Card title="Create Shift">
                <Row>
                    <Col xs={{ span: 24 }} sm={{ span: 24 }} md={{ span: 24 }} lg={{ span: 24, offset: 1 }} xl={{ span: 24, offset: 1 }} >
                        <Form
                            layout="vertical"
                            ...
                            <Row>
                                    ...
                                    >
                                        <div className='ant-picker' style={{ width: "100%" }}>
                                            <div className="ant-picker-input">
                                                <input type="time" id='startTime' className="form-control" style={{ width: "100%" }} />
                                            </div>
                                        </div>
                                    </Form.Item>
                                </Col>
                                ...
                                <Col xs={{ span: 24 }} sm={{ span: 24 }} md={{ span: 6 }} lg={{ span: 5 }} xl={{ span: 5 }}>
                                    ...
                                    >
                                        <div className='ant-picker' style={{ width: "100%" }}>
                                            <div className="ant-picker-input">
                                                <input type="time" id='endTime' className="form-control" style={{ width: "100%" }} />
                                            </div>
                                        </div>
                                    </Form.Item>
                                </Col>
