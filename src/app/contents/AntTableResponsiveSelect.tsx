...
export default function TableView(props: any) {
  ...
  const onchangeselectedData = (value:any,cond:any, key:any)=>{
    
    if (cond){

      let temp = [value,...selectedData];
      setselectedData(temp)
      props?.rowSelection(temp)
    } 

    if (!cond){
      let temp= selectedData.filter(item=>item.key!=key);
      setselectedData(temp)
      props?.rowSelection(temp)
    }
                    ...
                    <div >
                      {props?.rowSelection != undefined &&
                        <div style={{ textAlign: "center" }}>
                          ...
                          <Checkbox onChange={(e) => onchangeselectedData(rowData, e.target.checked, rowData.key)} ></Checkbox>
                        </div>
                      }
