 ...
 */
 ...
 export default function Bk(props:any) {
   
   const rowSelection = props.antTableProps.rowSelection;
   //console.log(rowSelection);
   
    const [rowData,setrowData] = React.useState<any>([]);   
    const [rowIndex,setrowIndex] = React.useState<any>([]);   
   
    const rowSelect = (e,data, key) => {
      let tempData;
      let tempIndex;
      console.log(data);
      if(e.target.checked===true){
      let newData = [...rowData];
      let newDataIndex = [...rowIndex];
      tempData=([...newData, data])
      setrowData(tempData);
      tempIndex=([...newDataIndex, key+1])
      setrowIndex(tempIndex);
      props.rowSelection(tempIndex,tempData)
     
    }

    console.log(rowData);
    //   props.rowSelection([1],[
    //     {
    //         "id": 1,
    //         "key": 1,
    //         "name": "Arif"
               ...
               props.antTableProps.dataSource.map((rowData:any, index:any) => {
                 ...
                 return (
                   ...
                   <div style={{ textAlign: "center" }}>
                          {/* <Checkbox defaultChecked onChange={(e) => props.rowSelection(rowData, e.target.checked)} ></Checkbox> */}
                          <Checkbox onChange={(e) => rowSelect(e, rowData,index)} ></Checkbox>
                        </div>
